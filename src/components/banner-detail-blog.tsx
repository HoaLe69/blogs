...
export default function BannerDetailBlog(props: Props) {
    ...
    <div className="relative overflow-clip">
      ...
      >
        <div className="absolute left-0 right-0">
          <div className="max-w-2xl mx-auto pb-[100px] px-4">
            <h1 className="font-medium">{title}</h1>
            <div className="mb-8 flex items-center text-text-secondary">
        ...
        >
          <path
            fill="var(--color-banner-third-bg)"
