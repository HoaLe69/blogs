...
export default async function Banner({ slug }: Props) {
  let frontMatter
  if (slug) {
...
function BannerOuter() {
  return (
    <svg
      ...
      preserveAspectRatio="none"
      className="min-w-[320rem] w-full max-w-[revert]"
    >
      <path
        fill="var(--color-bg-base)"
...
function BannerInner() {
  return (
    ...
    >
      ...
      ></path>
      <path
        fill="var(--color-banner-secondary-bg)"
