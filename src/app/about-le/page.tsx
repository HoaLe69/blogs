      ...
      <Container>
        ...
        <article className="prose lg:prose-lg dark:prose-invert max-w-none">
          ...
          <p>
            ...
            and aspiring Software Engineer. I&apos;m currently in my final year at{" "}
          ...
          <p>
            ...
            <span className="text-text-emphasis">learning</span>, and living as a student. I started this blog to share
            my experiences and insights as I navigate the world of Information Technology, particularly as a student
            who’s about to graduate and step into the professional world. Here, you&apos;ll find content related to:
          </p>
          <ul>
            <li>
              <strong>Data Structures & Algorithms</strong> – My experiences with these foundational concepts and tips
              on mastering them.
            </li>
            <li>
          ...
          <CustomImageCmp
            ...
            alt="home author"
            des="The is the another view of my hometown."
          />
          ...
          <p>
            I believe everyone&apos;s got a story worth sharing, and I hope this blog inspires to notice the little
